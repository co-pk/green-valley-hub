        ...
        <section className="bg-gradient-to-r from-valley-blue to-valley-green py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Parent Login</h1>
            ...
            <div className="max-w-md mx-auto">
              <Card className="shadow-lg">
                <CardHeader className="text-center">
                  <CardTitle className="text-2xl text-valley-blue">Parent Portal Access</CardTitle>
                ...
                <CardContent>
                  ...
                  <div className="mt-6 text-center text-sm text-muted-foreground">
                    ...
                    <p className="text-valley-blue font-medium">(555) 123-4568</p>
                  </div>
                </CardContent>
              </Card>
            </div>
